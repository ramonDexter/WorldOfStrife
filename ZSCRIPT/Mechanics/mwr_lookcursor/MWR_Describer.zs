...
class MWR_DescriberAddOn play abstract
{
...
class MWR_DescriberPercentage play 
{
...
class MWR_DescriberBase play abstract
{
...
class MWR_DescriberProvider : StaticEventHandler
{
	...
	static string DescribeLineTraceHit(FLineTraceData ltd, actor observer=null, bool examine=false, string strDefault=strIndescribable) {return GetInstance().DescribeLineTraceHit_Impl(ltd, observer, examine, strDefault);}
	static string YouSee_LineTraceHit(FLineTraceData ltd, actor observer=null, bool addons=true, bool examine=false, string strDefault=strIndescribable) {return GetInstance().YouSee_LineTraceHit_Impl(ltd, observer, addons, examine, strDefault);}
	static string DescribeActor(actor a, actor observer=null, bool examine=false, string strDefault=strIndescribable) {return GetInstance().DescribeActor_Impl(a, observer, examine, strDefault);}
	static string YouSee_Actor(actor a, actor observer=null, bool addons=true, bool examine=false, string strDefault=strIndescribable) {return GetInstance().YouSee_Actor_Impl(a, observer, addons, examine, strDefault);}
	...
	private virtual void InitializeYourself()
	{
	...
	private static MWR_DescriberProvider GetInstance()
	{
	...
	private string DescribeLineTraceHit_Impl(FLineTraceData ltd, actor observer=null, bool examine=false, string strDefault=strIndescribable)
	{
		string description;
	...
	private bool TryDescribeLineTraceHitToGdo(out GramDescObj TheObject, FLineTraceData ltd, actor observer=null, bool examine=false)
	{
	...
	private bool TryDescribeLineTraceHitToString(out string description, FLineTraceData ltd, actor observer=null, bool examine=false)
	{
	...
	private string DescribeActor_Impl(Actor a, actor observer=null, bool examine=true, string strDefault=strIndescribable)
	{
		string description;
	...
	private bool TryDescribeActorToGdo(out GramDescObj TheObject, Actor a, actor observer=null, bool examine=false)
	{
		for (uint i = 0; i < _describerBase.Size(); i++)
		{
	...
	private bool TryDescribeActorToString(out string description, actor a, actor observer=null, bool examine=false)
	{
		GramDescObj TheObject;
	...
	private bool TryNameLineTraceHit(out string TheName, in GramDescObj TheObject, FLineTraceData ltd, actor observer=null, bool examine=false)
	{
	...
	private bool TryNameActor(out string TheName, in GramDescObj TheObject, Actor a, actor observer=null, bool examine=false)
	{
		for (uint i = 0; i < _describerName.Size(); i++)
		{
	...
	static void ApplyName(in GramDescObj TheObject, string TheName)
	{
	...
	void BuildSentence_YouSee(out GramDescObj gdoSentence, in GramDescObj TheObject)
	{
		MWR_LanguageHandler.SetGdo(gdoSentence,gdo_text_YouSee);
		MWR_LanguageHandler.TryCombineGdoText(gdoSentence,'%o',TheObject);
	}
	private string YouSee_LineTraceHit_Impl(FLineTraceData ltd, actor observer=null, bool tryAddons=true, bool examine=false, string strDefault=strIndescribable)
	{
		GramDescObj TheObject;
	...
	private string YouSee_Actor_Impl(actor a, actor observer=null, bool tryAddons=true, bool examine=false, string strDefault=strIndescribable)
	{
		GramDescObj TheObject;
		GramDescObj TheSentence;
		if (TryDescribeActorToGdo(TheObject, a, observer, examine))
	...
	private bool TryDescribeActorAddons(out string Description, GramDescObj TheObject, actor a, actor observer=null, bool examine=false)
	{
	...
	private bool TryDescribeLineTraceHitAddons(out string Description, GramDescObj TheObject, FLineTraceData ltd, actor observer=null, bool examine=false)
	{
		for (uint i = 0; i < _describerAddon.Size(); i++)
		{
