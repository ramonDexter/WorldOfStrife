...
class laserPistol : wosWeapon {
	...
	States {
		...
		Fire:
			...
			LSPI A 1 { invoker.laserPistolIsFiring = true; }
		RealFire:
			...
			TNT1 A 0 { invoker.laserPistolIsFiring = false; }
			Goto Ready;
		Reload:
		...
		DoReload:
			...
			LSPR G 2;
			LSPR H 2;
			TNT1 A 0 A_StartSound("weapons/mmsl_in", 0);
			LSPR I 2;
			LSPR J 2;
			LSPR K 2;
			LSPR L 15;
...
class laserTracer : FastProjectile {
    ...
    States {
        ...
        Death:
            ...
            TNT1 AAAAAAAAAAAAAAAAAAAAA 0 A_SpawnParticle (
				"red", 
				...
				frandom(-4,4), frandom(-4,4), frandom(-4,4), 
				0, 0, 0, 
				1.0, 
				-0.1, 
				0.05
