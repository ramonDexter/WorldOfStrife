...
class laserPistol : augmentedWeapon {
	...
	States {
		...
		Deselect:
			...
			Loop;
		Ready:
			LSPI DEFGHI 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			Loop;
		Fire:			
			TNT1 A 0 A_JumpIf(invoker.laserPistolIsFiring == true, "RealFire");
			LSPI CBA 1 A_WeaponReady(WRF_ALLOWRELOAD|WRF_NOFIRE|WRF_NOSWITCH|WRF_ALLOWUSER1);
			LSPI A 1 {
		...
		RealFire:
			...
			LSPS ABCDEF 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			LSPS ABCDEF 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			LSPS ABCDEF 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			LSPS ABCDEF 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			LSPS ABCDEF 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			LSPS ABCDEF 3 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1);
			LSPI ABC 4 A_WeaponReady(WRF_ALLOWRELOAD|WRF_ALLOWUSER1|WRF_NOFIRE|WRF_NOSWITCH);
			TNT1 A 0 {
