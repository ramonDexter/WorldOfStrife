...
class dest_ShortBush : ShortBush Replaces ShortBush {
	...
	States
	{
        ...
        Death:
            ...
            TNT1 AAAAAAAAAAAAAAAAAAAAAAAAAAA 0 A_SpawnProjectile ("LeafParticle", 20, 0, random (0, 360), 2, random (30, 160));
            TNT1 AAAA 0 A_SpawnProjectile ("BushPiece1", 20, 0, random (0, 360), 2, random (30, 160));
            TNT1 AAAA 0 A_SpawnProjectile ("BushPiece2", 20, 0, random (0, 360), 2, random (30, 160));
			BUSH D -1;
            Stop;
	}
}
