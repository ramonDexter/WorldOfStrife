...
class wosStatusBar : BaseStatusBar {
	...
	protected void DrawMainBar (double TicFrac) {        
        ...
        if (item != null ) {     
            ...
            drawImage ("HUDfram", (-54, 0), DI_ITEM_OFFSETS);
            ...
            if (ammo2 != NULL) {
                DrawString(mGrnFont, FormatNumber(ammo1.Amount, 3, 5), (371, 137), DI_TEXT_ALIGN_RIGHT, Font.CR_GOLD);
                DrawString(mGrnFont, FormatNumber(ammo2.Amount, 3, 5), (371, 148), DI_TEXT_ALIGN_RIGHT, Font.CR_YELLOW);		
				//drawBar int vertical == 0 left>right; 1 right>left; 2 down>up; 3 up>down
				DrawBar("mgznBar", "mgznBck", ammo1.Amount, ammo1.MaxAmount, (365, 189), 0, 3);				
                DrawInventoryIcon (ammo2, (358, 158), DI_ITEM_OFFSETS);
            } else if ( ammo1 != NULL ) {
				DrawString(mGrnFont, FormatNumber(ammo1.Amount, 3, 5), (371, 137), DI_TEXT_ALIGN_RIGHT, Font.CR_GOLD);
				//DrawString(mGrnFont, FormatNumber(ammo2.Amount, 3, 5), (370, 148), DI_TEXT_ALIGN_RIGHT);		
				DrawBar("mgznBar", "mgznBck", ammo1.Amount, ammo1.MaxAmount, (366, 189), 0, 3);
				DrawInventoryIcon (ammo1, (358, 158), DI_ITEM_OFFSETS);
			}			
