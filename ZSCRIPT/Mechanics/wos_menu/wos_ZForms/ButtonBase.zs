...
class wos_ZF_ButtonBase : wos_ZF_Element {
	...
	private wos_ZF_BoxTextures textures[4];

	/// Returns the box textures used for when the button is in the inactive state.
	///
	/// See [`ButtonState`] for state descriptions.
	wos_ZF_BoxTextures getInactiveTexture() { return textures[ButtonState_Inactive]; }
	/// Sets the box textures used for when the button is in the inactive state.
	///
	/// See [`ButtonState`] for state descriptions.
	void setInactiveTexture(wos_ZF_BoxTextures tex) { textures[ButtonState_Inactive] = tex; }

	/// Returns the box textures used for when the button is in the hover state.
	///
	/// See [`ButtonState`] for state descriptions.
	wos_ZF_BoxTextures getHoverTexture() { return textures[ButtonState_Hover]; }
	/// Sets the box textures used for when the button is in the hover state.
	///
	/// See [`ButtonState`] for state descriptions.
	void setHoverTexture(wos_ZF_BoxTextures tex) { textures[ButtonState_Hover] = tex; }

	/// Returns the box textures used for when the button is in the click state.
	///
	/// See [`ButtonState`] for state descriptions.
	wos_ZF_BoxTextures getClickTexture() { return textures[ButtonState_Click]; }
	/// Sets the box textures used for when the button is in the click state.
	///
	/// See [`ButtonState`] for state descriptions.
	void setClickTexture(wos_ZF_BoxTextures tex) { textures[ButtonState_Click] = tex; }

	/// Returns the box textures used for when the button is in the disabled state.
	///
	/// See [`ButtonState`] for state descriptions.
	wos_ZF_BoxTextures getDisabledTexture() { return textures[ButtonState_Disabled]; }
	/// Sets the box textures used for when the button is in the disabled state.
	///
	/// See [`ButtonState`] for state descriptions.
	void setDisabledTexture(wos_ZF_BoxTextures tex) { textures[ButtonState_Disabled] = tex; }

	/// Sets all four of the textures a button uses in one function.
	///
	/// See [`ButtonState`] for state descriptions.
	void setTextures(wos_ZF_BoxTextures inactive, wos_ZF_BoxTextures hover, wos_ZF_BoxTextures click, wos_ZF_BoxTextures disabled) {
	...
	private wos_ZF_BoxDrawer drawers[4];
	...
	override void drawer() {
		...
		wos_ZF_BoxTextures textures = textures[curButtonState];
		if (textures != NULL) {
