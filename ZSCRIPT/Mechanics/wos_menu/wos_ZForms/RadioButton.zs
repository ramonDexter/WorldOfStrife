...
/// there.
class wos_ZF_RadioButton : wos_ZF_ButtonBase {
	/// ?doc: hidden
	void config(
		wos_ZF_RadioController variable, int value,
		...
		AlignType alignment = AlignType_Center, wos_ZF_Handler cmdHandler = NULL, Name command = ''
	) {
		setFont(fnt);
		setText(text);
	...
	static wos_ZF_RadioButton create(
		...
		let ret = new('wos_ZF_RadioButton');
